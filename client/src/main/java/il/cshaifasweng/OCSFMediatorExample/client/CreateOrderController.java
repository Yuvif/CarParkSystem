...
//        {
////            send alert that the field is empty
//            sendAlert("id not valid", " Invalid id", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(carIdTextBox.getText().isEmpty())
//        {
//            sendAlert("car id not valid", " Invalid car id", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(emailAddress.getText().isEmpty())
//        {
//            sendAlert("email not valid", " Invalid email", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(arrivalDate.getValue() == null)
//        {
//            sendAlert("arrival date not valid", " Invalid arrival date", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(estLeavingDate.getValue() == null)
//        {
//            sendAlert("estimated leaving date not valid", " Invalid estimated leaving date", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(estLeavingHour.getValue() == null)
//        {
//            sendAlert("estimated leaving hour not valid", " Invalid estimated leaving hour", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(parkingLotsOpt.getValue() == null)
//        {
//            sendAlert("parking lot not valid", " Invalid parking lot", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(arrivalHour.getValue() == null)
//        {
//            sendAlert("arrival hour not valid", " Invalid arrival hour", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(arrivalMin.getValue() == null)
//        {
//            sendAlert("arrival minute not valid", " Invalid arrival minute", Alert.AlertType.WARNING);
//            return false;
//        }
//        if(estLeavingMin.getValue() == null)
//        {
//            sendAlert("estimated leaving minute not valid", " Invalid estimated leaving minute", Alert.AlertType.WARNING);
//            return false;
//        }
